var defaultLocale = {
  ...
  "userguide-basics": "<h3>Basics</h3><p>Your body needs a certain amount of calories to maintain your current weight. We'll call this your maintenance level. You can increase your maintenance level by doing lots of exercise or you can decrease it by being more sedentary.</p><p>The easiest method (that is also pretty accurate) to calculate your maintenance level is to use a TDEE calculator. You can find plenty of these online.</p><p>To lose weight you should eat at least 100 calories per day less than your maintenance level, to gain weight you should eat at least 100 calories per day more than your maintenance level.</p><p>The less you eat per day the more weight you will lose, but eating too few calories will put your body into an unhealthy starvation state where you will actually hold onto your weight for longer and make yourself ill, don't do it.</p><p>There is no fast way to lose weight, it takes time to put it on and time to take it off. Be patient, track what you eat, cut down where you can, swap high-cal for low-cal, and be healthy.</p>",
